...
%global pkg_name greenwave_monitor_interfaces
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-greenwave-monitor-interfaces
Version:        1.0.0
Release:        4%{?dist}
...
%changelog
* Wed Apr 29 2026 Sean Gillen <sgillen@nvidia.com> - 1.0.0-4
- Autogenerated by Bloom

* Tue Apr 28 2026 Sean Gillen <sgillen@nvidia.com> - 1.0.0-3
- Autogenerated by Bloom

* Tue Apr 21 2026 Sean Gillen <sgillen@nvidia.com> - 1.0.0-2
- Autogenerated by Bloom
