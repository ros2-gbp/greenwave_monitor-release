...
Name:           ros-rolling-greenwave-monitor
Version:        1.0.0
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS greenwave_monitor package

License:        Apache-2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-diagnostic-msgs
Requires:       ros-rolling-greenwave-monitor-interfaces
...
BuildRequires:  ros-rolling-greenwave-monitor-interfaces
...
%changelog
* Fri Mar 20 2026 Sean Gillen <sgillen@nvidia.com> - 1.0.0-2
- Autogenerated by Bloom

* Thu Mar 19 2026 Sean Gillen <sgillen@nvidia.com> - 1.0.0-1
- Autogenerated by Bloom
